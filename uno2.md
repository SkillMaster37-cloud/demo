...
EcoRouter (HQ-RTR):
    baza:
        ...
        conf t
        port ge0 {к роутеру}
        service-instance ge0 {к роутеру}
        encapsuletion untagged
        int ge0
        ip add ___.___.___.___
        exit
    ...
    tunnel:
        ...
        ip add ___.___.___.___/___
        ip mtu 1400
        ip tunnel ___.___.___.___ ___.___.___.___ mode gre
    ...
    Internet HQ:
        ...
        ip nat pool VL200 ___.___.___.___ - ___.___.___.___
        ip nat pool VL999 ___.___.___.___ - ___.___.___.___
        ip nat sousce dynamic inside pool VL100 overload intesface ge0
        ip nat sousce dynamic inside pool VL200 overload intesface ge0
        ip nat sousce dynamic inside pool VL999 overload intesface ge0

BR-RTR:
    nano /etc/network/interfaces 
        auto ens___ 
        iface ens___ inet dhcp\static
        address ___.___.___.___ | gateway ___.___.___.___ (ip ISP)
    ...
    tunnel:
        ...
        nano /gre.up 
            #!bin/bash
            ip tunnel add gre1 mode gre remote ___.___.___.___ {ip router 1} local ___.___.___.___ {ip router 2} ttl 255
            ip link set gre1 up
